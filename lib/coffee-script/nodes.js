...
<<<<<<< HEAD
  ...
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; }, __indexOf = Array.prototype.indexOf || function(x) { var i = 0, l = this.length >>> 0; while (i++ < l) if (i in this && this[i] === x) return i; return -1; };
=======
...
<<<<<<< HEAD
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        if (!(_i in _ref2)) continue;
        attr = _ref2[_i];
        if (this[attr]) {
          _ref3 = flatten([this[attr]]);
          for (_j = 0, _len2 = _ref3.length; _j < _len2; _j++) {
            if (!(_j in _ref3)) continue;
            child = _ref3[_j];
...
>>>>>>> refs/remotes/jashkenas/master
  ...
  UTILITIES = {
    ...
    indexOf: function() {
<<<<<<< HEAD
      return "Array.prototype.indexOf || function(x) { var i = 0, l = this.length >>> 0; while (i++ < l) if (i in this && this[i] === x) return i; return -1; }";
=======
