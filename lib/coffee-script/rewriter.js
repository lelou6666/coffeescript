...
<<<<<<< HEAD
  ...
  var __indexOf = Array.prototype.indexOf || function(x) { var i = 0, l = this.length >>> 0; while (i++ < l) if (i in this && this[i] === x) return i; return -1; }, __slice = Array.prototype.slice;
=======
...
<<<<<<< HEAD
  for (_i = 0, _len = BALANCED_PAIRS.length; _i < _len; _i++) {
    if (!(_i in BALANCED_PAIRS)) continue;
